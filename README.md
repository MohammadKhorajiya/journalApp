...
Performance Tracking: Optimized data flow between Users and their Journal collections.

🛠️ Admin Powers
User Management: Admins can monitor all registered users in the system.

Promote to Admin: A specialized endpoint to upgrade existing users to Admin status without losing their personal data (City, Email, etc.).
